...
WITH TotalSales AS (
    -- Step 1: Calculate total sales grouped by market date
    SELECT 
        market_date,
...
RankedSales AS (
    -- Step 2: Rank the sales, ordering for highest and lowest sales
    SELECT 
        market_date,
        total_sales,
...
-- Step 3: Select the highest and lowest sales day using UNION
SELECT 
    market_date,
    total_sales,
